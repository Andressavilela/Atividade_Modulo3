...
namespace Agencia1.Controllers
{
    public class PacotesController : Controller
    {
        private readonly BancoDeDados _context;

        public PacotesController(BancoDeDados context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("PacoteId,Origem,Destino,Data,Retorno")] Pacote pacote)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PacoteId,Origem,Destino,Data,Retorno")] Pacote pacote)
        {
